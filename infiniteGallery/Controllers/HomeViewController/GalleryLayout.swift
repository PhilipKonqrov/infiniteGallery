...
public class GalleryLayout: UICollectionViewLayout {
    ...
    override public class var layoutAttributesClass: AnyClass {
        return GalleryLayoutAttributes.self
    }
        ...
        if cache.isEmpty {
            ...
            for section in 0..<numberOfSections {
                ...
                if let headerSize = delegate.collectionView?(
                    ...
                    let headerAttributes = GalleryLayoutAttributes(
                ...
                for item in 0..<numberOfItems {
                    ...
                    let attributes = GalleryLayoutAttributes(
                ...
                if let footerSize = delegate.collectionView?(
                    ...
                    let footerAttributes = GalleryLayoutAttributes(
